 ...
 */
open class BitbucketCompoundCriteria(private val criteria: BitbucketSearchCriteria) : BitbucketSearchCriteria {
 ...
 */
class ByBitbucketName(private val repositoryName: String, criteria: BitbucketSearchCriteria) :
