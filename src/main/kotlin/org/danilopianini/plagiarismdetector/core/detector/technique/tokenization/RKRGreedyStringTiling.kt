 ...
 */
class RKRGreedyStringTiling(minimumMatchLength: Int) : BaseGreedyStringTiling(minimumMatchLength) {
    ...
    private fun updateSearchLength(actualSearchLength: Int): Int = when {
